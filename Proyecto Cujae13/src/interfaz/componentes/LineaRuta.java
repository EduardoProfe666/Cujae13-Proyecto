...
public class LineaRuta extends JComponent{
	...
	public LineaRuta(int orientacion, String loc1, String loc2) {
		this(Color.BLACK,3,orientacion);
		this.loc1 = loc1;
		this.loc2 = loc2;
	}
	
	private LineaRuta(Color color, int grosor, int orientacion) {
		setBounds(0,0,50,50);
		this.color = color;
		this.grosor = grosor;
	...
	protected void paintComponent(Graphics g) {
		...
		g2.setColor(color);
		g2.setStroke(new BasicStroke(grosor,BasicStroke.CAP_ROUND,BasicStroke.JOIN_ROUND,5.0f,new float[] {6,6},0.0f));
	...
	public boolean comparacion(Localizacion l1, Localizacion l2) {
		boolean b = loc1.equals(l1.getNombre()) || loc1.equals(l2.getNombre());
		
		b &= loc2.equals(l1.getNombre()) || loc2.equals(l2.getNombre());
